...
def test_ai_bet_plans_choose_points_and_ticket_types_without_user_limit():
    ...
    assert set(plans) == {"的中重視", "バランス", "高回収狙い"}
